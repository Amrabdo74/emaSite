        ...
        <div className="flex flex-col md:flex-row items-center gap-12">
          ...
          <div className="flex-1">
            <div className="w-full h-96 bg-gradient-to-br from-blue-200 to-orange-200 rounded-lg flex items-center justify-center">
              <div className="text-center text-gray-600">
                ...
                <p className="text-lg">صورة من نحن</p>
              </div>
            </div>
          </div>
          ...
          <div className="flex-1 text-right space-y-6">
            ...
            <p className="text-lg text-gray-700 leading-relaxed">
              فريق رائد في مجال تصميم وبرمجة الموقع والتسويق الالكتروني، بدأ خدماته منذ عام 2013، وقدم خدماته التقنية لعدد كبير من العملاء والمؤسسات والمراكز والهيئات.
            </p>
            <p className="text-lg text-gray-700 leading-relaxed">
              فريق رائد في مجال تصميم وبرمجة الموقع والتسويق الالكتروني، بدأ خدماته منذ عام 2013، وقدم خدماته التقنية لعدد كبير من العملاء والمؤسسات والمراكز والهيئات.
            </p>
