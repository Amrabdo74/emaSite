    ...
    <footer id="contact" className="bg-blue-900 text-white py-16">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
          ...
          {/* Site Pages */}
          <div>
            <h3 className="text-xl font-bold mb-6 text-orange-500">صفحات الموقع</h3>
          ...
          {/* Social Media */}
          <div>
            <h3 className="text-xl font-bold mb-6 text-orange-500">وسائل التواصل</h3>
            <ul className="space-y-3">
        ...
        <div className="border-t border-blue-800 mt-12 pt-8 text-center text-gray-400">
          <p>&copy; 2025 EAM CO. جميع الحقوق محفوظة</p>
        </div>
      </div>
    </footer>
  );
